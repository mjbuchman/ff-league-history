...
INSERT INTO Matchups VALUES
    ...
    (2017,1,'Brenden Zarrinnam',113.04,'Jon Setzke',104.08,'FALSE','FALSE', 'TRUE'),
    ...
    (2017,2,'Joe Perry',121.06,'Jon Setzke',108.4,'FALSE','FALSE', 'TRUE'),
    ...
    (2017,3,'Jon Setzke',76.32,'Tyler Brown',151.92,'FALSE','FALSE', 'TRUE'),
    ...
    (2017,4,'James Earley',126.28,'Jon Setzke',126.78,'FALSE','FALSE', 'TRUE'),
    ...
    (2017,5,'Jon Setzke',80.54,'Sal DiVita',92.62,'FALSE','FALSE', 'TRUE'),
    ...
    (2017,6,'Ryan Rasmussen',129.42,'Jon Setzke',94.44,'FALSE','FALSE', 'TRUE'),
    ...
    (2017,7,'Zach Way',93.34,'Jon Setzke',143.48,'FALSE','FALSE', 'TRUE'),
    ...
    (2017,8,'Jon Setzke',129.12,'Connor DeYoung',134.78,'FALSE','FALSE', 'TRUE'),
    ...
    (2017,9,'Michael Buchman',113.52,'Jon Setzke',125.3,'FALSE','FALSE', 'TRUE'),
    ...
    (2017,10,'Jon Setzke',99.78,'Brenden Zarrinnam',94.84,'FALSE','FALSE', 'TRUE'),
    ...
    (2017,11,'Grant Dakovich',130.64,'Jon Setzke',120.58,'FALSE','FALSE', 'TRUE'),
    ...
    (2017,12,'Jon Setzke',96.62,'Sal DiVita',53.58,'FALSE','FALSE', 'FALSE'),
    ...
    (2017,13,'Jon Setzke',238.32,'Nick Eufrasio',217.78,'FALSE','TRUE', 'FALSE'),
    ...
    (2017,14,'Jon Setzke',247.92,'Tyler Brown',219.9,'FALSE','TRUE', 'FALSE'),
    ...
    (2018,1,'Michael Buchman',129.84,'Jon Setzke',157.46,'FALSE','FALSE', 'TRUE'),
    ...
    (2018,2,'Jon Setzke',138.24,'Joe Perry',157.5,'FALSE','FALSE', 'TRUE'),
    ...
    (2018,3,'Brenden Zarrinnam',67.16,'Jon Setzke',117.76,'FALSE','FALSE', 'TRUE'),
    ...
    (2018,4,'Ryan Rasmussen',165.22,'Jon Setzke',109.3,'FALSE','FALSE', 'TRUE'),
    ...
    (2018,5,'Jon Setzke',136.96,'James Earley',103.38,'FALSE','FALSE', 'TRUE'),
    ...
    (2018,6,'Tyler Brown',126.56,'Jon Setzke',159.68,'FALSE','FALSE', 'TRUE'),
    ...
    (2018,7,'Jon Setzke',106.34,'Nick Eufrasio',139.1,'FALSE','FALSE', 'TRUE'),
    ...
    (2018,8,'Jon Setzke',155.66,'Grant Dakovich',107.46,'FALSE','FALSE', 'TRUE'),
    ...
    (2018,9,'Connor DeYoung',187.6,'Jon Setzke',174,'FALSE','FALSE', 'TRUE'),
    ...
    (2018,10,'Jon Setzke',119.96,'Michael Buchman',160.9,'FALSE','FALSE', 'TRUE'),
    ...
    (2018,11,'Joe Perry',134.92,'Jon Setzke',134.58,'FALSE','FALSE', 'TRUE'),
    ...
    (2018,12,'Grant Dakovich',127.34,'Jon Setzke',122.32,'FALSE','FALSE', 'FALSE'),
    ...
    (2018,13,'Joe Perry',262.08,'Jon Setzke',230.92,'FALSE','TRUE', 'FALSE'),
    ...
    (2018,14,'Jon Setzke',285.4,'Nick Eufrasio',165.08,'FALSE','TRUE', 'FALSE'),
    (2019,1,'Nick Eufrasio',142.8,'Jon Setzke',85.96,'FALSE','FALSE', 'TRUE'),
    ...
    (2019,2,'Jon Setzke',147.2,'Brenden Zarrinnam',107.22,'FALSE','FALSE', 'TRUE'),
    ...
    (2019,3,'Connor DeYoung',130.24,'Jon Setzke',88.46,'FALSE','FALSE', 'TRUE'),
    ...
    (2019,4,'Jon Setzke',99.2,'Ryan Rasmussen',101.48,'FALSE','FALSE', 'TRUE'),
    ...
    (2019,5,'Michael Buchman',131.94,'Jon Setzke',150.96,'FALSE','FALSE', 'TRUE'),
    ...
    (2019,6,'Jon Setzke',118.54,'Joe Perry',150.44,'FALSE','FALSE', 'TRUE'),
    ...
    (2019,7,'James Earley',107.78,'Jon Setzke',93.76,'FALSE','FALSE', 'TRUE'),
    ...
    (2019,8,'Jon Setzke',131.04,'Grant Dakovich',161.94,'FALSE','FALSE', 'TRUE'),
    ...
    (2019,9,'Tyler Brown',123.62,'Jon Setzke',110.2,'FALSE','FALSE', 'TRUE'),
    ...
    (2019,10,'Jon Setzke',96.98,'Nick Eufrasio',121.7,'FALSE','FALSE', 'TRUE'),
    ...
    (2019,11,'Brenden Zarrinnam',74.48,'Jon Setzke',130.52,'FALSE','FALSE', 'TRUE'),
    ...
    (2019,12,'Tyler Brown',129.8,'Jon Setzke',81.54,'FALSE','FALSE', 'FALSE'),
    ...
    (2019,13,'Jon Setzke',224.58,'Brenden Zarrinnam',236.56,'FALSE','TRUE', 'FALSE'),
    ...
    (2019,14,'Jon Setzke',306.74,'Joe Perry',119.72,'FALSE','TRUE', 'FALSE'),
    (2020,1,'Jon Setzke',130.1,'Grant Dakovich',121.82,'FALSE','FALSE', 'TRUE'),
    ...
    (2020,2,'Joe Perry',110.18,'Jon Setzke',138.44,'FALSE','FALSE', 'TRUE'),
    ...
    (2020,3,'Jon Setzke',121.7,'Ryan Rasmussen',166.54,'FALSE','FALSE', 'TRUE'),
    ...
    (2020,4,'Michael Buchman',90.22,'Jon Setzke',140.7,'FALSE','FALSE', 'TRUE'),
    ...
    (2020,5,'Brenden Zarrinnam',119.32,'Jon Setzke',130.36,'FALSE','FALSE', 'TRUE'),
    ...
    (2020,6,'Jon Setzke',80.48,'Nick Eufrasio',112.94,'FALSE','FALSE', 'TRUE'),
    ...
    (2020,7,'James Earley',106.54,'Jon Setzke',113.82,'FALSE','FALSE', 'TRUE');
INSERT INTO Wallerstein_Matchup_Scores
    ...
    (2020,8,'Jon Setzke',126.92,'Grant Dakovich',98.94,'FALSE','FALSE', 'TRUE'),
    ...
    (2020,9,'Joe Perry',121.58,'Jon Setzke',156.96,'FALSE','FALSE','TRUE'),
    ...
    (2020,10,'Jon Setzke',106.52,'Ryan Rasmussen',137.06,'FALSE','FALSE','TRUE'),
    ...
    (2020,11,'Michael Buchman',153.06,'Jon Setzke',148.90,'FALSE','FALSE','TRUE'),
    ...
    (2020,12,'Brenden Zarrinnam',129.60,'Jon Setzke',141.72,'FALSE','FALSE','TRUE'),
    (2020,13,'Brenden Zarrinnam',242.78,'Michael Buchman',337.48,'TRUE','TRUE','FALSE'),
    (2020,13,'Jon Setzke',198.62,'Ryan Rasmussen',253.82,'TRUE','TRUE','FALSE'),
    ...
    (2020,14,'Brenden Zarrinnam',268.14,'Jon Setzke',279.80,'TRUE','TRUE','FALSE'),
    ...
    (2021,1,'Tyler Brown',171.37,'Michael Buchman',123.33,'FALSE','FALSE','TRUE'),
    (2021,1,'Ryan Rasmussen',122.05,'James Earley',140.66,'FALSE','FALSE','TRUE'),
    (2021,1,'Nick Eufrasio',163.46,'Jon Setzke',121.21,'FALSE','FALSE','TRUE'),
    (2021,1,'Joe Perry',158.98,'Connor DeYoung',80.95,'FALSE','FALSE','TRUE'),
    (2021,1,'Grant Dakovich',89.62,'Brenden Zarrinnam',99.67,'FALSE','FALSE','TRUE'),
    (2021,2,'Michael Buchman',134.33,'Joe Perry',113.12,'FALSE','FALSE','TRUE'),
    (2021,2,'Tyler Brown',152.12,'Ryan Rasmussen',114.41,'FALSE','FALSE','TRUE'),
    (2021,2,'James Earley',102.9,'Nick Eufrasio',134.42,'FALSE','FALSE','TRUE'),
    (2021,2,'Jon Setzke',109.94,'Grant Dakovich',127.3,'FALSE','FALSE','TRUE'),
    (2021,2,'Connor DeYoung',188.76,'Brenden Zarrinnam',109.88,'FALSE','FALSE','TRUE'),
    (2021,3,'Brenden Zarrinnam',136.97,'Michael Buchman',130.28,'FALSE','FALSE','TRUE'),
    (2021,3,'Ryan Rasmussen',112.82,'Nick Eufrasio',111.72,'FALSE','FALSE','TRUE'),
    (2021,3,'Joe Perry',115.24,'Tyler Brown',146.15,'FALSE','FALSE','TRUE'),
    (2021,3,'Grant Dakovich',147.29,'James Earley',122.09,'FALSE','FALSE','TRUE'),
    (2021,3,'Connor DeYoung',134.93,'Jon Setzke',101.74,'FALSE','FALSE','TRUE'),
    (2021,4,'Michael Buchman',109.45,'Jon Setzke',101.91,'FALSE','FALSE','TRUE'),
    (2021,4,'Joe Perry',127.38,'Ryan Rasmussen',91.32,'FALSE','FALSE','TRUE'),
    (2021,4,'Nick Eufrasio',113.36,'Grant Dakovich',126.77,'FALSE','FALSE','TRUE'),
    (2021,4,'Tyler Brown',118.22,'Brenden Zarrinnam',143.22,'FALSE','FALSE','TRUE'),
    (2021,4,'James Earley',170.82,'Connor DeYoung',140.29,'FALSE','FALSE','TRUE'),
    (2021,5,'Michael Buchman',116.35,'James Earley',139.51,'FALSE','FALSE','TRUE'),
    (2021,5,'Ryan Rasmussen',125.05,'Grant Dakovich',160.91,'FALSE','FALSE','TRUE'),
    (2021,5,'Brenden Zarrinnam',127.98,'Joe Perry',149.32,'FALSE','FALSE','TRUE'),
    (2021,5,'Connor DeYoung',193.13,'Nick Eufrasio',131.48,'FALSE','FALSE','TRUE'),
    (2021,5,'Jon Setzke',173.69,'Tyler Brown',114.13,'FALSE','FALSE','TRUE'),
    (2021,6,'Nick Eufrasio',127.09,'Michael Buchman',120.29,'FALSE','FALSE','TRUE'),
    (2021,6,'Brenden Zarrinnam',97.25,'Ryan Rasmussen',133.17,'FALSE','FALSE','TRUE'),
    (2021,6,'Grant Dakovich',134.45,'Connor DeYoung',114.78,'FALSE','FALSE','TRUE'),
    (2021,6,'Joe Perry',152.75,'Jon Setzke',110.58,'FALSE','FALSE','TRUE'),
    (2021,6,'Tyler Brown',144.93,'James Earley',146.11,'FALSE','FALSE','TRUE');