...
INSERT INTO Matchups VALUES
	...
	(2021,1,'James Earley',140.66,'Ryan Rasmussen',122.05,'FALSE','FALSE','TRUE'),
	(2021,1,'Michael Buchman',123.33,'Tyler Brown',171.37,'FALSE','FALSE','TRUE'),
	(2021,1,'Jonathan Setzke',121.21,'Nick Eufrasio',163.46,'FALSE','FALSE','TRUE'),
	(2021,1,'Connor DeYoung',80.95,'Joe Perry',158.98,'FALSE','FALSE','TRUE'),
	(2021,1,'Brenden Zarrinnam',99.67,'Grant Dakovich',89.62,'FALSE','FALSE','TRUE'),
	(2021,2,'Ryan Rasmussen',114.41,'Tyler Brown',152.12,'FALSE','FALSE','TRUE'),
	(2021,2,'Nick Eufrasio',134.42,'James Earley',102.9,'FALSE','FALSE','TRUE'),
	(2021,2,'Joe Perry',113.12,'Michael Buchman',134.33,'FALSE','FALSE','TRUE'),
	(2021,2,'Grant Dakovich',127.3,'Jonathan Setzke',109.94,'FALSE','FALSE','TRUE'),
	(2021,2,'Brenden Zarrinnam',109.88,'Connor DeYoung',188.76,'FALSE','FALSE','TRUE'),
	(2021,3,'Nick Eufrasio',111.72,'Ryan Rasmussen',112.82,'FALSE','FALSE','TRUE'),
	(2021,3,'Tyler Brown',146.15,'Joe Perry',115.24,'FALSE','FALSE','TRUE'),
	(2021,3,'James Earley',122.09,'Grant Dakovich',147.29,'FALSE','FALSE','TRUE'),
	(2021,3,'Michael Buchman',130.28,'Brenden Zarrinnam',136.97,'FALSE','FALSE','TRUE'),
	(2021,3,'Jonathan Setzke',101.74,'Connor DeYoung',134.93,'FALSE','FALSE','TRUE'),
	(2021,4,'Ryan Rasmussen',91.32,'Joe Perry',127.38,'FALSE','FALSE','TRUE'),
	(2021,4,'Grant Dakovich',126.77,'Nick Eufrasio',113.36,'FALSE','FALSE','TRUE'),
	(2021,4,'Brenden Zarrinnam',143.22,'Tyler Brown',118.22,'FALSE','FALSE','TRUE'),
	(2021,4,'Connor DeYoung',140.29,'James Earley',170.82,'FALSE','FALSE','TRUE'),
	(2021,4,'Jonathan Setzke',101.91,'Michael Buchman',109.45,'FALSE','FALSE','TRUE'),
	(2021,5,'Grant Dakovich',160.91,'Ryan Rasmussen',125.05,'FALSE','FALSE','TRUE'),
	(2021,5,'Joe Perry',149.32,'Brenden Zarrinnam',127.98,'FALSE','FALSE','TRUE'),
	(2021,5,'Nick Eufrasio',131.48,'Connor DeYoung',193.13,'FALSE','FALSE','TRUE'),
	(2021,5,'Tyler Brown',114.13,'Jonathan Setzke',173.69,'FALSE','FALSE','TRUE'),
	(2021,5,'James Earley',139.51,'Michael Buchman',116.35,'FALSE','FALSE','TRUE'),
	(2021,6,'Ryan Rasmussen',133.17,'Brenden Zarrinnam',97.25,'FALSE','FALSE','TRUE'),
	(2021,6,'Connor DeYoung',114.78,'Grant Dakovich',134.45,'FALSE','FALSE','TRUE'),
	(2021,6,'Jonathan Setzke',110.58,'Joe Perry',152.75,'FALSE','FALSE','TRUE'),
	(2021,6,'Michael Buchman',120.29,'Nick Eufrasio',127.09,'FALSE','FALSE','TRUE'),
	(2021,6,'James Earley',146.11,'Tyler Brown',144.93,'FALSE','FALSE','TRUE'),
	(2021,7,'Connor DeYoung',116.88,'Ryan Rasmussen',144.44,'FALSE','FALSE','TRUE'),
	(2021,7,'Brenden Zarrinnam',133.54,'Jonathan Setzke',115.69,'FALSE','FALSE','TRUE'),
	(2021,7,'Grant Dakovich',116.81,'Michael Buchman',120.41,'FALSE','FALSE','TRUE'),
	(2021,7,'Joe Perry',117.3,'James Earley',131.84,'FALSE','FALSE','TRUE'),
	(2021,7,'Nick Eufrasio',135.97,'Tyler Brown',100.49,'FALSE','FALSE','TRUE'),
	(2021,8,'Ryan Rasmussen',136.31,'Jonathan Setzke',95.46,'FALSE','FALSE','TRUE'),
	(2021,8,'Michael Buchman',125.9,'Connor DeYoung',107.91,'FALSE','FALSE','TRUE'),
	(2021,8,'James Earley',130.32,'Brenden Zarrinnam',73.35,'FALSE','FALSE','TRUE'),
	(2021,8,'Tyler Brown',123.9,'Grant Dakovich',118.86,'FALSE','FALSE','TRUE'),
	(2021,8,'Nick Eufrasio',104.28,'Joe Perry',107.82,'FALSE','FALSE','TRUE'),
	(2021,9,'Michael Buchman',116.46,'Ryan Rasmussen',92.61,'FALSE','FALSE','TRUE'),
	(2021,9,'Jonathan Setzke',97.9,'James Earley',90.83,'FALSE','FALSE','TRUE'),
	(2021,9,'Connor DeYoung',102.79,'Tyler Brown',98.14,'FALSE','FALSE','TRUE'),
	(2021,9,'Brenden Zarrinnam',115.03,'Nick Eufrasio',85.74,'FALSE','FALSE','TRUE'),
	(2021,9,'Grant Dakovich',109.67,'Joe Perry',121.94,'FALSE','FALSE','TRUE'),
	(2021,10,'Ryan Rasmussen',88.49,'James Earley',150.47,'FALSE','FALSE','TRUE'),
	(2021,10,'Tyler Brown',143.7,'Michael Buchman',93.77,'FALSE','FALSE','TRUE'),
	(2021,10,'Nick Eufrasio',67.44,'Jonathan Setzke',92.81,'FALSE','FALSE','TRUE'),
	(2021,10,'Joe Perry',128.8,'Connor DeYoung',107.27,'FALSE','FALSE','TRUE'),
	(2021,10,'Grant Dakovich',96.08,'Brenden Zarrinnam',118.74,'FALSE','FALSE','TRUE'),
	(2021,11,'Tyler Brown',126.25,'Ryan Rasmussen',111.21,'FALSE','FALSE','TRUE'),
	(2021,11,'James Earley',142.93,'Nick Eufrasio',119.68,'FALSE','FALSE','TRUE'),
	(2021,11,'Michael Buchman',135.44,'Joe Perry',164.98,'FALSE','FALSE','TRUE'),
	(2021,11,'Jonathan Setzke',109.78,'Grant Dakovich',121.2,'FALSE','FALSE','TRUE'),
	(2021,11,'Connor DeYoung',123.32,'Brenden Zarrinnam',121.56,'FALSE','FALSE','TRUE'),
	(2021,12,'Ryan Rasmussen',116.85,'Nick Eufrasio',96.88,'FALSE','FALSE','TRUE'),
	(2021,12,'Joe Perry',123.37,'Tyler Brown',137.7,'FALSE','FALSE','TRUE'),
	(2021,12,'Grant Dakovich',150.33,'James Earley',87.76,'FALSE','FALSE','TRUE'),
	(2021,12,'Brenden Zarrinnam',89.6,'Michael Buchman',137.48,'FALSE','FALSE','TRUE'),
	(2021,12,'Connor DeYoung',93.15,'Jonathan Setzke',140.89,'FALSE','FALSE','TRUE'),
	(2021,13,'Connor DeYoung',113.22,'Ryan Rasmussen',94.95,'FALSE','FALSE','FALSE'),
	(2021,13,'Grant Dakovich',120.91,'Michael Buchman',124.0,'TRUE','FALSE','FALSE'),
	(2021,13,'Tyler Brown',145.07,'Brenden Zarrinnam',104.77,'TRUE','FALSE','FALSE'),
	(2021,13,'Joe Perry',136.13,'Nick Eufrasio',117.61,'FALSE','FALSE','FALSE'),
	(2021,13,'James Earley',134.47,'Jonathan Setzke',112.62,'FALSE','FALSE','FALSE'),
	(2021,14,'Joe Perry',263.99,'Michael Buchman',268.14,'TRUE','TRUE','FALSE'),
	(2021,14,'James Earley',226.7,'Tyler Brown',268.47,'TRUE','TRUE','FALSE'),
	(2021,14,'Grant Dakovich',225.06,'Connor DeYoung',223.01,'FALSE','TRUE','FALSE'),
	(2021,14,'Brenden Zarrinnam',180.62,'Ryan Rasmussen',252.32,'FALSE','TRUE','FALSE'),
	(2021,14,'Nick Eufrasio',188.24,'Jonathan Setzke',213.33,'FALSE','TRUE','FALSE'),
	(2021,15,'Tyler Brown',247.93,'Michael Buchman',278.84,'TRUE','TRUE','FALSE'),
	(2021,15,'Joe Perry',177.67,'James Earley',192.02,'TRUE','TRUE','FALSE'),
	(2021,15,'Grant Dakovich',241.3,'Ryan Rasmussen',238.51,'FALSE','TRUE','FALSE'),
	(2021,15,'Connor DeYoung',263.79,'Jonathan Setzke',260.68,'FALSE','TRUE','FALSE'),
	(2021,15,'Brenden Zarrinnam',169.69,'Nick Eufrasio',176.43,'FALSE','TRUE','FALSE'),
	(2022,1,'Brenden Zarrinnam',156.3,'James Earley',170.18,'FALSE','FALSE','TRUE'),
	(2022,1,'Joe Perry',117.92,'Grant Dakovich',133.1,'FALSE','FALSE','TRUE'),
	(2022,1,'Michael Buchman',141.36,'Nick Eufrasio',98.45,'FALSE','FALSE','TRUE'),
	(2022,1,'Tyler Brown',143.62,'Connor DeYoung',106.02,'FALSE','FALSE','TRUE'),
	(2022,1,'Ryan Rasmussen',100.36,'Jonathan Setzke',74.21,'FALSE','FALSE','TRUE'),
	(2022,2,'James Earley',120.93,'Grant Dakovich',144.43,'FALSE','FALSE','TRUE'),
	(2022,2,'Nick Eufrasio',153.76,'Brenden Zarrinnam',108.65,'FALSE','FALSE','TRUE'),
	(2022,2,'Connor DeYoung',160.83,'Joe Perry',102.73,'FALSE','FALSE','TRUE'),
	(2022,2,'Jonathan Setzke',85.55,'Michael Buchman',88.46,'FALSE','FALSE','TRUE'),
	(2022,2,'Ryan Rasmussen',130.16,'Tyler Brown',145.62,'FALSE','FALSE','TRUE'),
	(2022,3,'Nick Eufrasio',100.05,'James Earley',98.05,'FALSE','FALSE','TRUE'),
	(2022,3,'Grant Dakovich',93.16,'Connor DeYoung',142.27,'FALSE','FALSE','TRUE'),
	(2022,3,'Brenden Zarrinnam',103.03,'Jonathan Setzke',103.86,'FALSE','FALSE','TRUE'),
	(2022,3,'Joe Perry',94.41,'Ryan Rasmussen',105.24,'FALSE','FALSE','TRUE'),
	(2022,3,'Michael Buchman',104.08,'Tyler Brown',117.07,'FALSE','FALSE','TRUE'),
	(2022,4,'James Earley',126.42,'Connor DeYoung',151.83,'FALSE','FALSE','TRUE'),
	(2022,4,'Jonathan Setzke',156.8,'Nick Eufrasio',99.14,'FALSE','FALSE','TRUE'),
	(2022,4,'Ryan Rasmussen',103.1,'Grant Dakovich',103.81,'FALSE','FALSE','TRUE'),
	(2022,4,'Tyler Brown',135.61,'Brenden Zarrinnam',112.46,'FALSE','FALSE','TRUE'),
	(2022,4,'Michael Buchman',125.9,'Joe Perry',137.48,'FALSE','FALSE','TRUE'),
	(2022,5,'Jonathan Setzke',93.54,'James Earley',145.86,'FALSE','FALSE','TRUE'),
	(2022,5,'Connor DeYoung',142.98,'Ryan Rasmussen',80.66,'FALSE','FALSE','TRUE'),
	(2022,5,'Nick Eufrasio',140.38,'Tyler Brown',154.91,'FALSE','FALSE','TRUE'),
	(2022,5,'Grant Dakovich',142.61,'Michael Buchman',82.67,'FALSE','FALSE','TRUE'),
	(2022,5,'Brenden Zarrinnam',116.98,'Joe Perry',145.9,'FALSE','FALSE','TRUE'),
	(2022,6,'James Earley',127.21,'Ryan Rasmussen',94.81,'FALSE','FALSE','TRUE'),
	(2022,6,'Tyler Brown',79.6,'Jonathan Setzke',105.41,'FALSE','FALSE','TRUE'),
	(2022,6,'Michael Buchman',67.02,'Connor DeYoung',150.6,'FALSE','FALSE','TRUE'),
	(2022,6,'Joe Perry',91.03,'Nick Eufrasio',117.75,'FALSE','FALSE','TRUE'),
	(2022,6,'Brenden Zarrinnam',121.92,'Grant Dakovich',109.9,'FALSE','FALSE','TRUE'),
	(2022,7,'Tyler Brown',107.3,'James Earley',77.52,'FALSE','FALSE','TRUE'),
	(2022,7,'Ryan Rasmussen',132.68,'Michael Buchman',127.77,'FALSE','FALSE','TRUE'),
	(2022,7,'Jonathan Setzke',114.55,'Joe Perry',125.21,'FALSE','FALSE','TRUE'),
	(2022,7,'Connor DeYoung',134.94,'Brenden Zarrinnam',108.42,'FALSE','FALSE','TRUE'),
	(2022,7,'Nick Eufrasio',100.96,'Grant Dakovich',71.07,'FALSE','FALSE','TRUE'),
	(2022,8,'James Earley',83.05,'Michael Buchman',130.83,'FALSE','FALSE','TRUE'),
	(2022,8,'Joe Perry',141.6,'Tyler Brown',143.07,'FALSE','FALSE','TRUE'),
	(2022,8,'Brenden Zarrinnam',119.72,'Ryan Rasmussen',150.53,'FALSE','FALSE','TRUE'),
	(2022,8,'Grant Dakovich',159.25,'Jonathan Setzke',139.0,'FALSE','FALSE','TRUE'),
	(2022,8,'Nick Eufrasio',128.43,'Connor DeYoung',128.88,'FALSE','FALSE','TRUE'),
	(2022,9,'Joe Perry',118.5,'James Earley',116.1,'FALSE','FALSE','TRUE'),
	(2022,9,'Michael Buchman',87.85,'Brenden Zarrinnam',118.19,'FALSE','FALSE','TRUE'),
	(2022,9,'Tyler Brown',129.07,'Grant Dakovich',112.92,'FALSE','FALSE','TRUE'),
	(2022,9,'Ryan Rasmussen',150.18,'Nick Eufrasio',88.05,'FALSE','FALSE','TRUE'),
	(2022,9,'Jonathan Setzke',175.62,'Connor DeYoung',143.14,'FALSE','FALSE','TRUE'),
	(2022,10,'James Earley',109.15,'Brenden Zarrinnam',135.99,'FALSE','FALSE','TRUE'),
	(2022,10,'Grant Dakovich',111.7,'Joe Perry',102.7,'FALSE','FALSE','TRUE'),
	(2022,10,'Nick Eufrasio',112.98,'Michael Buchman',104.19,'FALSE','FALSE','TRUE'),
	(2022,10,'Connor DeYoung',70.16,'Tyler Brown',114.68,'FALSE','FALSE','TRUE'),
	(2022,10,'Jonathan Setzke',135.58,'Ryan Rasmussen',125.4,'FALSE','FALSE','TRUE'),
	(2022,11,'Grant Dakovich',124.3,'James Earley',158.73,'FALSE','FALSE','TRUE'),
	(2022,11,'Brenden Zarrinnam',88.41,'Nick Eufrasio',101.8,'FALSE','FALSE','TRUE'),
	(2022,11,'Joe Perry',127.32,'Connor DeYoung',106.55,'FALSE','FALSE','TRUE'),
	(2022,11,'Michael Buchman',103.15,'Jonathan Setzke',97.12,'FALSE','FALSE','TRUE'),
	(2022,11,'Tyler Brown',132.71,'Ryan Rasmussen',131.15,'FALSE','FALSE','TRUE'),
	(2022,12,'James Earley',110.97,'Nick Eufrasio',96.65,'FALSE','FALSE','TRUE'),
	(2022,12,'Connor DeYoung',92.7,'Grant Dakovich',140.36,'FALSE','FALSE','TRUE'),
	(2022,12,'Jonathan Setzke',164.45,'Brenden Zarrinnam',99.05,'FALSE','FALSE','TRUE'),
	(2022,12,'Ryan Rasmussen',151.06,'Joe Perry',135.93,'FALSE','FALSE','TRUE'),
	(2022,12,'Tyler Brown',107.06,'Michael Buchman',117.86,'FALSE','FALSE','TRUE'),
	(2022,13,'Tyler Brown',134.69,'Connor DeYoung',149.69,'FALSE','FALSE','FALSE'),
	(2022,13,'Nick Eufrasio',109.43,'Grant Dakovich',132.05,'FALSE','FALSE','FALSE'),
	(2022,13,'Jonathan Setzke',113.91,'Ryan Rasmussen',77.0,'FALSE','FALSE','FALSE'),
	(2022,13,'Brenden Zarrinnam',144.72,'James Earley',125.92,'FALSE','FALSE','FALSE'),
	(2022,13,'Michael Buchman',82.3,'Joe Perry',118.44,'FALSE','FALSE','FALSE'),
	(2022,14,'Tyler Brown',268.98,'Jonathan Setzke',224.13,'TRUE','TRUE','FALSE'),
	(2022,14,'Connor DeYoung',290.81,'Grant Dakovich',277.83,'TRUE','TRUE','FALSE'),
	(2022,14,'Joe Perry',271.29,'Ryan Rasmussen',244.36,'FALSE','TRUE','FALSE'),
	(2022,14,'Nick Eufrasio',168.05,'James Earley',262.49,'FALSE','TRUE','FALSE'),
	(2022,14,'Michael Buchman',167.75,'Brenden Zarrinnam',233.77,'FALSE','TRUE','FALSE'),
	(2022,15,'Tyler Brown',222.14,'Connor DeYoung',269.55,'TRUE','TRUE','FALSE'),
	(2022,15,'Grant Dakovich',251.16,'Jonathan Setzke',199.16,'TRUE','TRUE','FALSE'),
	(2022,15,'Joe Perry',244.75,'James Earley',189.58,'FALSE','TRUE','FALSE'),
	(2022,15,'Ryan Rasmussen',201.98,'Brenden Zarrinnam',220.83,'FALSE','TRUE','FALSE'),
	(2022,15,'Nick Eufrasio',209.86,'Michael Buchman',221.23,'FALSE','TRUE','FALSE'),
	(2023,1,'Grant Dakovich',135.25,'Tyler Brown',107.49,'FALSE','FALSE','TRUE'),
	(2023,1,'Michael Buchman',117.56,'Joe Perry',104.54,'FALSE','FALSE','TRUE'),
	(2023,1,'Brenden Zarrinnam',75.74,'Connor DeYoung',126.78,'FALSE','FALSE','TRUE'),
	(2023,1,'James Earley',107.66,'Jonathan Setzke',127.49,'FALSE','FALSE','TRUE'),
	(2023,1,'Ryan Rasmussen',94.31,'Nick Eufrasio',88.42,'FALSE','FALSE','TRUE'),
	(2023,2,'Tyler Brown',167.06,'Joe Perry',124.71,'FALSE','FALSE','TRUE'),
	(2023,2,'Connor DeYoung',142.13,'Grant Dakovich',126.52,'FALSE','FALSE','TRUE'),
	(2023,2,'Jonathan Setzke',78.44,'Michael Buchman',111.7,'FALSE','FALSE','TRUE'),
	(2023,2,'Nick Eufrasio',125.26,'Brenden Zarrinnam',99.15,'FALSE','FALSE','TRUE'),
	(2023,2,'Ryan Rasmussen',104.5,'James Earley',136.53,'FALSE','FALSE','TRUE'),
	(2023,3,'Connor DeYoung',99.91,'Tyler Brown',166.77,'FALSE','FALSE','TRUE'),
	(2023,3,'Joe Perry',125.17,'Jonathan Setzke',60.86,'FALSE','FALSE','TRUE'),
	(2023,3,'Grant Dakovich',122.13,'Nick Eufrasio',163.98,'FALSE','FALSE','TRUE'),
	(2023,3,'Michael Buchman',159.05,'Ryan Rasmussen',115.96,'FALSE','FALSE','TRUE'),
	(2023,3,'Brenden Zarrinnam',126.48,'James Earley',126.48,'FALSE','FALSE','TRUE'),
	(2023,4,'Tyler Brown',141.75,'Jonathan Setzke',101.47,'FALSE','FALSE','TRUE'),
	(2023,4,'Nick Eufrasio',74.01,'Connor DeYoung',117.05,'FALSE','FALSE','TRUE'),
	(2023,4,'Ryan Rasmussen',129.7,'Joe Perry',68.18,'FALSE','FALSE','TRUE'),
	(2023,4,'James Earley',110.2,'Grant Dakovich',158.21,'FALSE','FALSE','TRUE'),
	(2023,4,'Brenden Zarrinnam',94.77,'Michael Buchman',195.88,'FALSE','FALSE','TRUE'),
	(2023,5,'Nick Eufrasio',141.36,'Tyler Brown',99.26,'FALSE','FALSE','TRUE'),
	(2023,5,'Jonathan Setzke',103.14,'Ryan Rasmussen',201.48,'FALSE','FALSE','TRUE'),
	(2023,5,'Connor DeYoung',87.91,'James Earley',80.89,'FALSE','FALSE','TRUE'),
	(2023,5,'Joe Perry',124.22,'Brenden Zarrinnam',111.29,'FALSE','FALSE','TRUE'),
	(2023,5,'Grant Dakovich',136.47,'Michael Buchman',137.57,'FALSE','FALSE','TRUE'),
	(2023,6,'Tyler Brown',99.71,'Ryan Rasmussen',144.95,'FALSE','FALSE','TRUE'),
	(2023,6,'James Earley',119.87,'Nick Eufrasio',77.09,'FALSE','FALSE','TRUE'),
	(2023,6,'Brenden Zarrinnam',116.34,'Jonathan Setzke',76.35,'FALSE','FALSE','TRUE'),
	(2023,6,'Michael Buchman',113.38,'Connor DeYoung',129.85,'FALSE','FALSE','TRUE'),
	(2023,6,'Grant Dakovich',149.55,'Joe Perry',140.03,'FALSE','FALSE','TRUE'),
	(2023,7,'James Earley',91.98,'Tyler Brown',123.65,'FALSE','FALSE','TRUE'),
	(2023,7,'Ryan Rasmussen',130.08,'Brenden Zarrinnam',150.21,'FALSE','FALSE','TRUE'),
	(2023,7,'Nick Eufrasio',115.17,'Michael Buchman',132.76,'FALSE','FALSE','TRUE'),
	(2023,7,'Jonathan Setzke',84.41,'Grant Dakovich',124.11,'FALSE','FALSE','TRUE'),
	(2023,7,'Connor DeYoung',84.41,'Joe Perry',101.54,'FALSE','FALSE','TRUE'),
	(2023,8,'Tyler Brown',100.86,'Brenden Zarrinnam',90.2,'FALSE','FALSE','TRUE'),
	(2023,8,'Michael Buchman',164.72,'James Earley',113.78,'FALSE','FALSE','TRUE'),
	(2023,8,'Grant Dakovich',140.46,'Ryan Rasmussen',128.96,'FALSE','FALSE','TRUE'),
	(2023,8,'Joe Perry',118.76,'Nick Eufrasio',113.56,'FALSE','FALSE','TRUE'),
	(2023,8,'Connor DeYoung',160.37,'Jonathan Setzke',121.23,'FALSE','FALSE','TRUE'),
	(2023,9,'Michael Buchman',99.91,'Tyler Brown',96.22,'FALSE','FALSE','TRUE'),
	(2023,9,'Brenden Zarrinnam',101.6,'Grant Dakovich',119.38,'FALSE','FALSE','TRUE'),
	(2023,9,'James Earley',124.13,'Joe Perry',123.72,'FALSE','FALSE','TRUE'),
	(2023,9,'Ryan Rasmussen',122.4,'Connor DeYoung',107.67,'FALSE','FALSE','TRUE'),
	(2023,9,'Nick Eufrasio',114.46,'Jonathan Setzke',137.8,'FALSE','FALSE','TRUE'),
	(2023,10,'Tyler Brown',121.38,'Grant Dakovich',138.72,'FALSE','FALSE','TRUE'),
	(2023,10,'Joe Perry',123.65,'Michael Buchman',104.52,'FALSE','FALSE','TRUE'),
	(2023,10,'Connor DeYoung',154.78,'Brenden Zarrinnam',98.24,'FALSE','FALSE','TRUE'),
	(2023,10,'Jonathan Setzke',102.03,'James Earley',111.27,'FALSE','FALSE','TRUE'),
	(2023,10,'Nick Eufrasio',136.31,'Ryan Rasmussen',119.59,'FALSE','FALSE','TRUE'),
	(2023,11,'Joe Perry',149.75,'Tyler Brown',95.5,'FALSE','FALSE','TRUE'),
	(2023,11,'Grant Dakovich',122.55,'Connor DeYoung',94.64,'FALSE','FALSE','TRUE'),
	(2023,11,'Michael Buchman',112.95,'Jonathan Setzke',87.16,'FALSE','FALSE','TRUE'),
	(2023,11,'Brenden Zarrinnam',129.68,'Nick Eufrasio',147.21,'FALSE','FALSE','TRUE'),
	(2023,11,'James Earley',85.21,'Ryan Rasmussen',90.22,'FALSE','FALSE','TRUE'),
	(2023,12,'Tyler Brown',136.81,'Connor DeYoung',133.11,'FALSE','FALSE','TRUE'),
	(2023,12,'Jonathan Setzke',124.49,'Joe Perry',108.4,'FALSE','FALSE','TRUE'),
	(2023,12,'Nick Eufrasio',117.69,'Grant Dakovich',151.3,'FALSE','FALSE','TRUE'),
	(2023,12,'Ryan Rasmussen',117.26,'Michael Buchman',120.38,'FALSE','FALSE','TRUE'),
	(2023,12,'James Earley',116.03,'Brenden Zarrinnam',106.52,'FALSE','FALSE','TRUE'),
	(2023,13,'Connor DeYoung',99.92,'Joe Perry',112.9,'TRUE','FALSE','FALSE'),
	(2023,13,'Ryan Rasmussen',176.73,'Tyler Brown',156.39,'TRUE','FALSE','FALSE'),
	(2023,13,'Nick Eufrasio',145.31,'James Earley',86.12,'FALSE','FALSE','FALSE'),
	(2023,13,'Brenden Zarrinnam',102.35,'Jonathan Setzke',107.45,'FALSE','FALSE','FALSE'),
	(2023,13,'Michael Buchman',128.28,'Grant Dakovich',194.17,'FALSE','FALSE','FALSE'),
	(2023,14,'Michael Buchman',254.35,'Joe Perry',238.97,'TRUE','TRUE','FALSE'),
	(2023,14,'Grant Dakovich',171.95,'Ryan Rasmussen',188.95,'TRUE','TRUE','FALSE'),
	(2023,14,'Jonathan Setzke',271.29,'Tyler Brown',245.18,'FALSE','TRUE','FALSE'),
	(2023,14,'Nick Eufrasio',246.55,'James Earley',264.63,'FALSE','TRUE','FALSE'),
	(2023,14,'Connor DeYoung',139.19,'Brenden Zarrinnam',248.24,'FALSE','TRUE','FALSE'),
	(2023,15,'Michael Buchman',232.23,'Ryan Rasmussen',175.23,'TRUE','TRUE','FALSE'),
	(2023,15,'Grant Dakovich',317.12,'Joe Perry',206.15,'FALSE','TRUE','FALSE'),
	(2023,15,'James Earley',245.57,'Jonathan Setzke',206.53,'FALSE','TRUE','FALSE'),
	(2023,15,'Tyler Brown',238.34,'Brenden Zarrinnam',213.65,'FALSE','TRUE','FALSE'),
	(2023,15,'Connor DeYoung',155.89,'Nick Eufrasio',252.62,'FALSE','TRUE','FALSE');